...
AppVerName=The Musical Cow 0.2 (21 August 2006)
...
[Files]
Source: lyricscow.exe; DestDir: {app}; Flags: 32bit
Source: *; Excludes: *.~*,\Temp\*,error.log,setup.iss,*.sh; Flags: recursesubdirs; DestDir: {app}; Components: ; Tasks: ; Languages: 
